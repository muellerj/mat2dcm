...
% GRUPPENKENNLINIE numeric/numeric
expect(~isempty(regexp(filecontent, [...
'GRUPPENKENNLINIE KL_LOOKUP_LINE_NUMERIC_NUMERIC 3\n' ...
'   ST/X   -10.000   0.000   100.000\n' ...
'   WERT   2.000   -0.100   2.100\n' ...
'END\n' ...
])));

% GRUPPENKENNLINIE text/numeric
expect(~isempty(regexp(filecontent, [...
'GRUPPENKENNLINIE KL_LOOKUP_LINE_TEXT_NUMERIC 3\n' ...
'   ST_TX/X   "foo"   "bar"   "baz"\n' ...
'   WERT   1.000   -10.200   5.000\n' ...
'END\n' ...
])));

% GRUPPENKENNLINIE numeric/text
expect(~isempty(regexp(filecontent, [...
'GRUPPENKENNLINIE KL_LOOKUP_LINE_NUMERIC_TEXT 3\n' ...
'   ST/X   1.000   2.000   3.000\n' ...
'   TEXT   "foo"   "bar"   "baz"\n' ...
'END\n' ...
])));

% GRUPPENKENNLINIE text/text
expect(~isempty(regexp(filecontent, [...
'GRUPPENKENNLINIE KL_LOOKUP_LINE_TEXT_TEXT 3\n' ...
'   ST_TX/X   "a"   "b"   "c"\n' ...
'   TEXT   "foo"   "bar"   "baz"\n' ...
'END\n' ...
])));
